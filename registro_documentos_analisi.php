...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/style.css?see=1.3">
        ...
        <body>
            <div class="contenedorregistros">
                <div class="containeelemetes">
                    <div class="containertitle">
                        <div class="contedorformus">
                            ...
                            <form action="" method="dialog" class="formularioregistros" enctype="multipart/form-data" id="FormAna">
                                <div class="context">
                                    <h2 class="titleregistros">Registros de analisis.</h2>
                                </div>
                                <hr>
                                <div class="inputsgrid">
                                    <div class="cajainputs">
                                        ...
                                        <div class="cajahijoinput">
                                            <select name="nombre" id="selectoptionAnanombre">
                                ...
                                <div class="inputsgrid2">
                                    <div class="cajainputs">
                                        <div class="cajahijoinput">
                                            <label for="archivos">Añadir análisis: </label> 
                                ...
                                <div class="inputsgrid3">
                                    <div class="cajainputs">
                                        <div class="cajahijoinput">
                                            <input type="submit" id="SubmitFormAna" value="Enviar solicitud">
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <script type="text/javascript" src="js/dbaseana.js?see=1.1"></script>
        </body>
